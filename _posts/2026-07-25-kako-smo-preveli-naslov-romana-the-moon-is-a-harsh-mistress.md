...
Glavni izazovi s kojima smo se suočili bili su lingvističke i kulturološke prirode:

1. **Problem gramatičkog roda:** U engleskom je jeziku Mjesec (*Moon*) u ovoj metafori personificiran kao žensko biće, što se prirodno veže uz riječ *mistress*. U hrvatskom je Mjesec imenica muškog roda. Svaki pokušaj da se izravno prenese ta ženska personifikacija zvučao je usiljeno ili nekonzistentno s duhom hrvatskog jezika.
2. **Dvije višeznačne riječi:** Riječi *harsh* i *mistress* nose iznimno bogat sloj značenja:
...
Nakon višemjesečnog brusnog procesa, testiranja ritma izgovora i konzultacija s lektoricom  i urednikom (tada još putem Skypea, ako ga se tko sjeća 😊), došli smo do naslova koji je objedinio sve dimenzije izvornika:
...
*Tražite li književnog prevoditelja  s engleskog jezika koji posvećuje jednaku pažnju svakoj riječi, a ne samo naslovu vašeg izdanja? [Javite se za procjenu projekta ili ogledni prijevod]({{ '/#contact' | relative_url }}).*
